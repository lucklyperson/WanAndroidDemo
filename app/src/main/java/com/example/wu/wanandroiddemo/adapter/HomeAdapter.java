...
public class HomeAdapter extends BaseQuickAdapter<Article.DataBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, Article.DataBean item) {
        ...
        helper.setText(R.id.tvNiceDate, item.getNiceDate());
        helper.setImageResource(R.id.ivCollect, item.isCollect() ? R.drawable.ic_favorite_collected_24dp : R.drawable.ic_favorite_uncollected_24dp);
