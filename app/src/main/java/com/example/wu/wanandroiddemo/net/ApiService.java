package com.example.wu.wanandroiddemo.net;
...
public interface ApiService {
     ...
     */
    @GET("/banner/json")
    Observable<DataResponse<List<BannerEntity>>> getHomeBanners();
     ...
     */
    @GET("/tree/json")
    Observable<DataResponse<List<SystemKnowledge>>> getKnowledgeSystems();
    ...
    @FormUrlEncoded
    Observable<DataResponse> removeCollectArticle(@Path("id") int id, @Field("originId") String originId);
